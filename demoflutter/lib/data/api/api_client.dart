import 'dart:convert';
import 'package:demoflutter/data/model/response/error_response.dart';
import 'package:flutter/foundation.dart';
import 'package:get/get_connect/http/src/request/request.dart';

import 'package:demoflutter/helper/responsive_helper.dart';
...
class ApiClient extends GetxService {
  ...
  Map<String, String> updateHeader(String? token, String? languageCode,
    ...
    header.addAll({
      ...
      "localization": languageCode ?? AppConstants.languages[0].languageCode!,
  ...
  Future<Response> postDataWithoutBody(String uri,
  ...
  Future<Response> getData2(String uri,
      {Map<String, dynamic>? query, Map<String, String>? headers}) async {
    try {
      if (kDebugMode) {
        print('====> API Call: $uri\nHeader: $_mainHeaders');
