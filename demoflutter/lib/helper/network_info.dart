...
import 'package:demoflutter/controller/network_controller.dart';
...
class NetworkInfo {
  ...
  static void checkConnectivity(BuildContext context) {
    Connectivity().onConnectivityChanged.listen((ConnectivityResult result) {
      if (Get.find<NetworkController>().firstTimeConnectionCheck) {
        Get.find<NetworkController>().setFirstTimeConnectionCheck(false);
      } else {
